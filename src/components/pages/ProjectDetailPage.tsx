      ...
      {activeTab === 'readme' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4 h-fit">
            <h3 className="font-bold text-sm text-zinc-900 dark:text-zinc-100 font-mono border-b border-zinc-100 dark:border-zinc-800 pb-2">
              Key Features
            </h3>
      ...
      {activeTab === 'ci' && (
        <div className="space-y-6">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
            <h3 className="font-bold text-base text-zinc-900 dark:text-zinc-100 font-mono">
