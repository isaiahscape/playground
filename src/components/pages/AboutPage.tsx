      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-3 shadow-xs">
          ...
          <p className="text-xs text-zinc-600 dark:text-zinc-300 leading-relaxed">
            Every application hosted on <code className="font-mono text-red-600 dark:text-red-400 font-bold">play.isaiahthings.me</code> is designed with strict respect for user privacy. Anchor, Bedrock, and Material Explorer operate entirely client-side or offline-first, storing user and configuration data locally without background tracking or sellable analytics.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-3 shadow-xs">
          ...
          <p className="text-xs text-zinc-600 dark:text-zinc-300 leading-relaxed">
            Contributions, bug reports, feature requests, and pull requests are warmly welcomed! Visit the GitHub organization at <a href="https://github.com/isaiahscape" target="_blank" rel="noopener noreferrer" className="text-red-600 dark:text-red-400 font-mono underline font-semibold">github.com/isaiahscape</a> to open issues or submit code.
          </p>
        </div>
